...
public Plugin myinfo= {
    name = "Agent Hunt",
    author = "boogameow",
    description = "You die, you're one of them. Modified version of ABM.",
...
public void OnPluginStart() {
    ...
    g_InfectedNames = new ArrayList(MAX_INF_NAMESIZE, 6);
...
public void OnSurvivorBackToLife(Handle event, const char[] name, bool dontBroadcast) {
	...
	ClientChar.GetValue(newbotid, userid);
...
public void QAfkHook(Handle event, const char[] name, bool dontBroadcast) {
    ...
    ClientChar.SetValue(newbotid, userid);
}
